...
class __TwigTemplate_e9464661fcefefa0902f9e9513363b4291fa8f8c3d065f4315f9d512c7562ef5 extends Twig_Template
{
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["circuitP"]) {
            ...
            echo "\">
                        ";
            // line 44
            if (twig_in_filter(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["circuitP"], "getCircuit", array(), "method"), "id", array()), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new Twig_Error_Runtime('Variable "app" does not exist.', 44, $this->source); })()), "session", array()), "get", array(0 => "likes"), "method"))) {
                // line 45
                echo "                            unlike
                        ";
            } else {
    ...
    ";
        ...
        <table class=\"table\">
            ...
            // line 73
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["circuitsNP"]) || array_key_exists("circuitsNP", $context) ? $context["circuitsNP"] : (function () { throw new Twig_Error_Runtime('Variable "circuitsNP" does not exist.', 73, $this->source); })()));
            $context['_iterated'] = false;
    ...
    {
        return array (  229 => 92,  220 => 88,  211 => 84,  203 => 81,  196 => 79,  188 => 76,  184 => 74,  179 => 73,  165 => 61,  163 => 60,  158 => 57,  149 => 53,  141 => 49,  137 => 47,  133 => 45,  131 => 44,  127 => 43,  121 => 40,  115 => 37,  107 => 34,  100 => 32,  94 => 29,  88 => 26,  80 => 23,  76 => 21,  71 => 20,  53 => 4,  44 => 3,  15 => 1,);
    }
