...
// Returns the private 'App\Repository\CircuitRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CircuitRepository.php';

return $this->privates['App\Repository\CircuitRepository'] = new \App\Repository\CircuitRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
