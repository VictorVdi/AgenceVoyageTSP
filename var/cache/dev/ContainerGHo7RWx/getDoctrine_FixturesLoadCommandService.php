...
include_once $this->targetDirs[3].'/src/DataFixtures/LoadCircuitData.php';
...
include_once $this->targetDirs[3].'/src/DataFixtures/LoadEtapeData.php';
include_once $this->targetDirs[3].'/src/DataFixtures/LoadProgrammationCircuitData.php';

$a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);
$a->addFixtures(array(0 => new \App\DataFixtures\LoadCircuitData(), 1 => new \App\DataFixtures\LoadEtapeData(), 2 => new \App\DataFixtures\LoadProgrammationCircuitData()));
