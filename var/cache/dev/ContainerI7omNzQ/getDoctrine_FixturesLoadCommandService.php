...
include_once $this->targetDirs[3].'/src/DataFixtures/LoadProgrammationCircuit.php';

$a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);
$a->addFixtures(array(0 => new \App\DataFixtures\LoadCircuitData(), 1 => new \App\DataFixtures\LoadEtapeData(), 2 => new \App\DataFixtures\LoadProgrammationCircuit()));
