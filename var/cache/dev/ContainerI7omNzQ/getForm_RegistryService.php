...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\CircuitType' => function () {
    return ($this->privates['App\Form\CircuitType'] ?? $this->privates['App\Form\CircuitType'] = new \App\Form\CircuitType());
