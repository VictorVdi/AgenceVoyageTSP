...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CircuitRepository' => function () {
...
}, 'App\\Repository\\ProgrammationCircuitRepository' => function () {
    return ($this->privates['App\Repository\ProgrammationCircuitRepository'] ?? $this->load('getProgrammationCircuitRepositoryService.php'));
