...
// Returns the private 'App\Repository\ProgrammationCircuitRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProgrammationCircuitRepository.php';

return $this->privates['App\Repository\ProgrammationCircuitRepository'] = new \App\Repository\ProgrammationCircuitRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
